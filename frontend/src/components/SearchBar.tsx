  ...
  return (
    <div className="relative">
      <input
        ...
        className="bg-transparent text-white px-3 py-2 rounded-lg outline-none w-full transition-all placeholder:text-gray-500"
      />
      {showDropdown && results.length > 0 && (
        <div className="absolute top-full mt-3 w-full bg-gray-800/95 backdrop-blur-sm rounded-lg shadow-2xl max-h-[60vh] sm:max-h-96 overflow-y-auto custom-scrollbar z-[100] border border-gray-700/50">
          {results.map((pkg) => (
            <button
              key={pkg.id}
